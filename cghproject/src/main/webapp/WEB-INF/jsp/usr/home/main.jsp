...
<div class="cslider">
		...
		<a href="/usr/info/info" class="fa-solid fa-bowl-food">맛집 추천</a>
		
		<a href="/usr/info/info3" class="fa-solid fa-car">현 교통량</a>
		
		<a href="/usr/info/info4" class="fa-solid fa-bed">숙박 시설</a>
		</div>
...
<div class ="afterslider">대전의 정취를 느껴보세요</div>
<style>
